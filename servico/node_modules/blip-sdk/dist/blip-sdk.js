	...
	var ArtificialIntelligenceExtension = function (_ExtensionBase) {
	    ...
	    _createClass(ArtificialIntelligenceExtension, [{
	        ...
	        value: function getAnalysis() {
	            ...
	            var intents = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : [];
	            var feedbacks = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : [];
	            var source = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : '';
	            var beginDate = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : '';
	            var endDate = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : '';
	            var minScore = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : '';
	            var maxScore = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : '';
	        ...
	        value: function getLastTrainedOrPublishedModel() {
	            return this._processCommand(this._createGetCommand(UriTemplates.LAST_TRAINED_OR_PUBLISH_MODEL, this._to));
	        }
	    }, {
	        key: 'trainModel',
